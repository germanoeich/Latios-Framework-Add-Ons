...
{
	[NodeCustomEditor(typeof(AnimationParameterNode))]
	public class AnimationParameterNodeView : BaseNodeView
    {
        AnimationParameterNode parameterNode;

        public override void Enable(bool fromInspector = false)
        {
            parameterNode = nodeTarget as AnimationParameterNode;
